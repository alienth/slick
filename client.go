...
// A websocket 'client'. There will be at least three of these - one client to
// the slack server, one client to the slack client, and one client to the
// third party.
type Client struct {
	hub  *Hub
	conn *websocket.Conn
...
func (c *Client) readPump() {
	...
	for {
		messageType, m, err := c.conn.ReadMessage()
		if err != nil {
